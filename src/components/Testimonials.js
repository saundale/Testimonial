...
const Testimonials = (props)=>{
  ...
  return(
    <div className="w-[85vw] md:w-[700px] bg-white flex flex-col justify-center mt-10 p-10 items-center transition-all duration-700
    hover:shadow-xl rounded-md">
      ...
      <div className="mt-6">
        ...
        px-10 py-2 rounded-md font-bold text-whit text-lg">Surprise Me</button>
      </div>
    </div>
  )
}
